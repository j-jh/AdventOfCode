...
public class Day2 {
	...
	public static int calculateSafeRows(List<List<Integer>> rowCollection) {
		int validRowCount = 0;
	...
	public static int calculateSafeRowsAfterRemoval(List<List<Integer>> rowCollection) {
		int validRowCount = 0;
		for (List<Integer> row : rowCollection) {
			if (isSafeRow(row)) {
				validRowCount++;
	...
	public static boolean isSafeRow(List<Integer> row) {
	...
	public static boolean isSafeRowAfterRemoval(List<Integer> row) {
	...
	public static List<List<Integer>> processLineToLists(Scanner scanner) {
