...
public class Day1 {
	...
	public static int calculateSimilarityScore(List<Integer> columnOneList, List<Integer> columnTwoList) {
	...
	public static int calculateSumFromLists(List<Integer> columnOneList, List<Integer> columnTwoList) {
		int totalSum = 0;
	...
	public static List<List<Integer>> processFileToLists(Scanner scanner) {
